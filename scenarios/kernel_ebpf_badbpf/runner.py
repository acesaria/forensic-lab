...
# Builder paths
REMOTE_ARCHIVE = "/tmp/badbpf-upstream.tar.gz"
REMOTE_BUILD_SCRIPT = "/tmp/badbpf-build.sh"
REMOTE_XCRYPTO_SOURCE = "/tmp/xcrypto.c"
REMOTE_BUILD_ROOT = "/tmp/forensic-lab/badbpf_build"
